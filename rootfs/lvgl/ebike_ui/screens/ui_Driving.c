...
void ui_Driving_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Speed_Number_2, LV_SIZE_CONTENT);   /// 100
    ...
    lv_obj_set_width(ui_Speed_Number_1, LV_SIZE_CONTENT);   /// 150
    ...
    lv_obj_clear_flag(ui_Slider_Speed, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE |
